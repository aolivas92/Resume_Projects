...
root.iconbitmap('ico-icon-11.ico')
...
def edit():
    ...
    editor.iconbitmap('ico-icon-11.ico')
    editor.geometry("380x190")
...
submit_button.grid(row=6, column=0, columnspan=2, pady=10, padx=10, ipadx=111)
...
delete_btn.grid(row=10, column=0, columnspan=2, pady=10, padx=10, ipadx=138)
